...
public class AllocateUnassignedDecisionTests extends ESTestCase {
    ...
    public void testNoDecision() {
        ...
        Map<String, AllocateUnassignedDecision.WeightedDecision> nodeDecisions = new HashMap<>();
        nodeDecisions.put("node1", new AllocateUnassignedDecision.WeightedDecision(Decision.NO));
        nodeDecisions.put("node2", new AllocateUnassignedDecision.WeightedDecision(Decision.NO));
    ...
    public void testThrottleDecision() {
        ...
        nodeDecisions.put("node1", new AllocateUnassignedDecision.WeightedDecision(Decision.NO));
        nodeDecisions.put("node2", new AllocateUnassignedDecision.WeightedDecision(Decision.THROTTLE));
    ...
    public void testYesDecision() {
        Map<String, AllocateUnassignedDecision.WeightedDecision> nodeDecisions = new HashMap<>();
        nodeDecisions.put("node1", new AllocateUnassignedDecision.WeightedDecision(Decision.YES));
        nodeDecisions.put("node2", new AllocateUnassignedDecision.WeightedDecision(Decision.NO));
